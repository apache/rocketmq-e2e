...
public class PullParamTest extends BaseOperate {
    ...
    private static String topic = getTopic("PullParamTest");
    ...
    public void testNormal_pull_receive_multi_nack() {
        ...
        DataCollector<MessageExt> dequeueMessages = DataCollectorManager.getInstance()
