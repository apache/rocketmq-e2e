...
public class PullAckTest extends BaseOperate {
    ...
    private static String topic = getTopic("PullAckTest");
    ...
    @Test
    @Timeout(180)
    @DisplayName("Send 5 normal messages synchronously and expect lite pull consumer to consume with receive and ack messages successful")
    ...
    @Test
    @Timeout(180)
    @DisplayName("Send 5 normal messages synchronously and expect pull consumer to consume with receive and ack messages successful")
