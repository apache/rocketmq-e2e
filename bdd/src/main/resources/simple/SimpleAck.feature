...
Feature: Test SimpleConsumer pulls messages and returns acks synchronously or asynchronously
...
#    感觉有点奇怪，为什么还没创建消息，就能拉取消息呢
    ...
    And SimpleConsumer invokes receive method "<TransmissionMode>" and returns acks "<AckMode>"
    Then Check all messages are pulled by SimpleConsumer "successfully"
